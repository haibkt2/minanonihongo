			...
			<div class="main-left">
				<div class="blog-detail-container">
					...
					<div class="blog-social-like">
						<iframe
							src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Flocalhost%3A8888%2Fvan-hoa-nhat-ban%2F${post.getPostId().substring(4)}-${sv.toUrlFriendly(post.getPostTitle())}&width=450&layout=standard&action=like&size=small&show_faces=true&share=true&height=80&appId=2272220076356331"
