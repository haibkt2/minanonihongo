...
<div class="main" style="min-height: 750px">
	<div class="main-center">
		<div class="main-left">
			...
			<c:forEach items="${listPost}" var="post" varStatus="postId">
				<c:if test="${postId.index%3 == 0}">
					<div class="page" id="page${postId.index + 1}">
						<div class="news-item featured">
							<a
								...
								<div class="title">Mình đã lấy được 173 điểm kì thi N3
									JLPT tháng 7/2018 như thế nào?</div>
							</a> <span class="info"><i class="fa fa-user"></i> &nbsp;
								&nbsp; <i class="fa fa-calendar-check-o"></i> 03 tháng 09, lúc
								20:04 &nbsp; &nbsp; Lượt xem 222222222 : 4930 </span> <span
								class="brief">Trước đây 3 năm mình đã sang Nhật với tư
								cách là tu nghiệp sinh. Trước khi sang Nhật mình đã học tiếng
								đến bài 25 ( theo sách minna nhé) nhưng lúc đó mình chỉ học cho
								có với mục đích chính là sang Nhật để kiếm tiền và không hề có
								đam mê hay hứng thú gì với tiếng Nhật cả. Sau khi sang đến nước
								Nhật rồi khoảng thời gian ban đầu mình cũng chưa thay đổi suy
								nghĩ bên trên cho lắm, vẫn giữ cái suy nghĩ chỉ cần biết vài câu
								tiếng Nhật như là chào hỏi &amp; giao tiếp cơ bản thôi, từ sáng
								đến tối mình chỉ đi làm, bản thân mình cũng giao tiếp rất ít với
								người Nhật vì thế nên cuộc sống của mình hồi đó có thể nói khá
								là nhàm chán. Mình cảm giác mình giống như con robot vậy, cho
								đến năm thứ 3 ở Nhật thì tự cảm thấy mình cần phải thay đổi lại
		...
		<c:set value="${postId/3}" var="np"></c:set>
		</c:forEach>
