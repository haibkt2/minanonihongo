	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="mn-exam-jlpt">
				<form action="${contextPath}/admin/update-course/update-exam">
					<!-- Main content -->
									...
									<div class="box-body pad">
										<div>
											<button type="submit" class="btn btn-info btn-flat"
												onclick="saveExam()" style="margin: 5px 0 0 40px">Hoàn sdasasd
												tất</button>
										</div>
										<div class="box-body">
												...
												<c:forEach items="${jt.jlptQuestions}" var="qt">
														<table id="data-exam" change-data="n" dt-db="ys"
															...
															<tbody class="list-ans">
																<c:forEach items="${qt.jlptAnswer}" var="as" varStatus="in">
																	...
																	<c:if test="${(in.index + 1) eq qt.jlptAnswer.size() }">
																	<tr>
																		<td></td>
